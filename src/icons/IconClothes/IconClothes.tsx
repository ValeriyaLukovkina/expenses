...
export interface IconClothesProps extends SVGAttributes<SVGSVGElement> {
  className?: string;
}

const IconClothes: FC<IconClothesProps> = (props) => {
  return (
    <svg
